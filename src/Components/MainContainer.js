...
// const classCount = chatData.reduce((student,acc)=>{
//   acc[student.class] = (acc[student.class] ||  0) +1;
// },{});

const totalStudents = chatData.length;
const classCounts = chatData.reduce((counts, student) => {
    ...
    <div>
      <div className="main-container">
        <div className='mainContainerCards '>
          <div className='studentCard main-cards'>
            <img src='images/student.png' alt='studentIcon' />
            <div> <h2>Students</h2>
              <p>60k</p>
            </div>
          </div>
          <div className='EventCards main-cards'>
            <img src='images/banner.png' alt='EventsIcon' />
            <div>
              <h2>Events</h2>
              <p>4k</p>
            </div>
          </div>
          <div className='paymentsCards main-cards'>
            <img src='images/credit-card (1).png' alt='Paymenticon' />
            <div>
              <h2>Payments</h2>
              <p>999k</p>
            </div>
